  ...
  <div class="user-profile-container">
    <n-card :bordered="false" class="profile-card" size="large">
      ...
      <n-form
        ...
        class="profile-form"
      >
        <n-card title="持仓情况" class="form-block view-card">
          <!-- 数量输入区：仅编辑模式显示 -->
          ...
          <div v-if="!isEditing" class="holdings-view">
            <div
              class="holdings-grid"
              v-if="formData.user_investment_profile.current_holdings.holdings_list?.length > 0"
            >
              <div
                class="holding-card"
                  ...
                  <div class="detail-item">
                    ...
                    <div class="detail-content">
                      ...
                      <div class="detail-value">{{
                        stock.purchase_price ? `¥${stock.purchase_price.toFixed(2)}` : '未设置'
                      }}</div>
                    </div>
                  </div>
